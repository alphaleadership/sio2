...
class PathConstructionStrategy {
  ...
  constructWebkitPath(destFolder, file) {
    try {
      if (!file.webkitRelativePath || file.webkitRelativePath.trim() === '') {
        throw new Error('webkitRelativePath is missing or empty, cannot use webkit strategy');
      }
  ...
  constructSmartPath(destFolder, file) {
    try {
      ...
      if (!file.webkitRelativePath || file.webkitRelativePath.trim() === '') {
        throw new Error('webkitRelativePath is missing or empty, cannot use smart strategy');
      }

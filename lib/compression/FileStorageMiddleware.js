      ...
      if (isFolderUpload) {
        ...
        for (const file of req.files) {
          try {
            ...
            // Logique anti-duplication : détecter si webkitRelativePath causerait une duplication
            let subPath;
            ...
            if (file.webkitRelativePath && isFolderUpload) {
              ...
              if (hasDuplication || hasUserPatternDuplication) {
                ...
                console.log(`Duplication évitée pour ${file.originalname}: utilise basename au lieu de webkitRelativePath`);
              } else {
  ...
  async handleFolderCreation(folderPath, files) {
    try {
      ...
      for (const file of files) {
        try {
          // Appliquer la même logique anti-duplication que pour les uploads individuels
          ...
          if (relativePath) {
            ...
            if (hasDuplication || hasUserPatternDuplication) {
              ...
              console.log(`Duplication évitée dans dossier pour ${file.name}: utilise basename au lieu du chemin complet`);
            }
          }
          ...
          if (fileDir !== folderPath) {
            ...
            const relativeDirPath = path.relative(folderPath, fileDir);
